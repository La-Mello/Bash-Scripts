...
*	# Takes parameter
	...
	WIFEXITED(wstatus) returns true if process exited normally with no errors


	# Returns:
		The pid of the child process/on which we are waiting to
		the process that has changed the state
